    ...
    $(document).ready(function () {
       ...
       get_edit_course()
       var student_id = localStorage.getItem('admin_student_id');
       console.log(student_id)
    })
    function get_edit_course()
    {
        var d = { 'course_id': localStorage.getItem('admin_course_id'),
                    'teacher_id':1,
                'student_id': localStorage.getItem('admin_student_id')};

        $.ajax({
            type: "POST",
            url: "../teacher/student_progress_dbop",
            dataType: 'Json',
